...
export default function ContactForm() {
  ...
  return (
    <div className="bg-gray-900 grid-pattern relative overflow-hidden" id="contact">
      ...
      <div className="max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white neon-text mb-6">Contact Us</h2>
